...
// const MonacoEditor=({code,zoom,error,compilationResult})=>{
//     return (
...
const MonacoEditor: React.FC<MonacoEditorProps> = ({file,code,error,compilationResult}) => {
  const [content, setContent] = useState(file.content == undefined ? code : file.content);

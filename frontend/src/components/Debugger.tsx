...
const Debugger=()=>{
    ...
    const mockStateData=[
        ...
        {name:"allowances",type:"mapping(address=>mapping(address=>uint256))",value:"{...}"}
    ];
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="mt-3">
                                ...
                                <div className="text-gray-600 text-sm mt-2">
                                   Debug a transaction from the deployed contracts or start isDebugging
                        ...
                        <div className="flex flex-col gap-3">
                          ...
                          <div className="mt-4">
                            <div className="flex border-b">
                                <button
                                  className={`py-2 px-3 text-xs font-medium ${activePanel==='stack'?'border b-2 border-black':''}`}
                                  onClick={()=>setActivePanel('stack')}
                                >
                                    Function Stack
                                </button>
                                <button
                                  className={`py-2 px-3 text-xs font-medium ${activePanel==='locals'?'border-b-2 border-black':''}`}
                                  onClick={()=>setActivePanel('locals')} 
                                >
                                    Solidity Locals
                                </button>
                                <button
                                  className={`py-2 px-3 text-xs font-medium ${activePanel==='state'?'border-b-2 border-black':''}`}
                                >
                                    Solidity State
                                </button>
                            </div>
